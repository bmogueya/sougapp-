              ...
              {loading ? (
                ...
                users.map((user) => (
                  <tr key={user.id} className="border-b border-border hover:bg-surface-2 transition-colors">
                    <td data-label="Nom Complet" className="px-6 py-4">
                      <span className="sm:hidden text-xs text-muted font-medium block mb-1">Nom Complet</span>
                      <span className="font-medium text-text">{user.first_name} {user.last_name}</span>
                    </td>
                    <td data-label="Rôle" className="px-6 py-4">
                      <span className="sm:hidden text-xs text-muted font-medium block mb-1">Rôle</span>
